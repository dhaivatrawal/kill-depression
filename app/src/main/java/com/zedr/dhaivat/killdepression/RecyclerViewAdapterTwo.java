...
class RecyclerViewAdapterTwo extends RecyclerView.Adapter<RecyclerViewAdapterTwo.ClubViewHolder>{


    List<Two.Club> clubs;

   public RecyclerViewAdapterTwo(List<Two.Club> clubs){
        this.clubs=clubs;
    }
    ...
    @NonNull
    @Override
    public RecyclerViewAdapterTwo.ClubViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewAdapterTwo.ClubViewHolder holder, int position) {
